...
import "./QuasteToken.sol";
import "./RecyclingFacility.sol";
import "./UserManagement.sol";
import "./WasteCollectionContract.sol";
import "./WasteCollectionPayment.sol";
import "./WasteCollectorAssignment.sol";
import "./WasteCollectorRating.sol";
